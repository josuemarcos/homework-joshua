...
Comment.create(:article_id => '1', :content => 'Nice Article!', :author_name => 'John', :created_at => Time.now)
Comment.create(:article_id => '1', :content => 'I loved it!', :author_name => 'Mariah', :created_at => Time.now)
Comment.create(:article_id => '1', :content => 'Normal comment', :author_name => 'User', :created_at => Time.now)
